...
# python combine_results.py --results-dir ffnn_acc --out-csv "ffnn_acc/ffnn_acc_avg_$FLAG_FRAC-$AT_R.csv" --out-png "ffnn_acc/ffnn_acc_avg_$FLAG_FRAC-$AT_R.png" --title "SPECTRA FFNN Detection Scores" --pattern "ffnn_acc_*.csv"
