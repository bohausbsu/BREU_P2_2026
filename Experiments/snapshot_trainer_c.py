...
class FourKAE(_BaseAE):
    """~4k params (bottleneck=3)."""

    def __init__(self, in_features=784, out_features=None):
        super().__init__(bottleneck=2, in_features=in_features)


class SixKAE(_BaseAE):
    """~5.5k params (bottleneck=3)."""

    def __init__(self, in_features=784, out_features=None):
        super().__init__(bottleneck=3, in_features=in_features)


class EightKAE(_BaseAE):
    """~8.6k params (bottleneck=5)."""

    def __init__(self, in_features=784, out_features=None):
        super().__init__(bottleneck=5, in_features=in_features)


class TenKAE(_BaseAE):
    """~10.2k params (bottleneck=6)."""

    def __init__(self, in_features=784, out_features=None):
        super().__init__(bottleneck=6, in_features=in_features)


class TwelveKAE(_BaseAE):
    """~11.8k params (bottleneck=7)."""

    def __init__(self, in_features=784, out_features=None):
        super().__init__(bottleneck=7, in_features=in_features)
