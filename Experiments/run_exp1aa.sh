#!/bin/bash
#SBATCH -J spectra_exp1aa
#SBATCH -o spectra_exp1aa.log%j
...
for i in {1..10}; do
	...
	python Experiment1a.py \
		...
		--out-csv "ffnn_acc_$i-$FLAG_FRAC-$AT_R-$EFF_SIGNAL_RATIO.csv" \
		--out "ffnn_acc_$i-$FLAG_FRAC-$AT_R-$EFF_SIGNAL_RATIO.png"
