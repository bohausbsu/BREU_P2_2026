...
for i in {1..5}; do
	time python ExperimentSAE.py --seed 1 --model SixKCNN --dataset-root PetImages --flag-frac "$FLAG_FRAC" --at-r "$AT_R" --out-csv "sae_exp/sae_cnn_6k-$i-$FLAG_FRAC-$AT_R.csv"
done
