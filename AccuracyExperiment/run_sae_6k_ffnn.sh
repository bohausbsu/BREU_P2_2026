...
time python ExperimentSAE.py --seed 1 --model SixKMLP --dataset college_student_placement_dataset.csv --target-col Placement --flag-frac "$FLAG_FRAC" --at-r "$AT_R" --out-csv "sae_ffnn_6k-$FLAG_FRAC-$AT_R.csv"
mv sae_*.csv sae_exp/
