...
class FourKCNN(_BaseCNN):
    """~4k params (w=14)."""

    def __init__(self, in_channels=3, out_features=1):
        super().__init__(width=14)


class SixKCNN(_BaseCNN):
    """~5.7k params (w=17)."""

    def __init__(self, in_channels=3, out_features=1):
        super().__init__(width=17)


class EightKCNN(_BaseCNN):
    """~7.8k params (w=20)."""
...
class TenKCNN(_BaseCNN):
    """~10.3k params (w=23)."""

    def __init__(self, in_channels=3, out_features=1):
        super().__init__(width=23)


class TwelveKCNN(_BaseCNN):
    """~12.1k params (w=25)."""

    def __init__(self, in_channels=3, out_features=1):
        super().__init__(width=25)
