...
time python ExperimentSAE.py --seed 1 --model FourKAE --data-root-ae mnist --flag-frac "$FLAG_FRAC" --at-r "$AT_R" --out-csv "sae_ae_4k-$FLAG_FRAC-$AT_R.csv" --out "sae_ae_4k-$FLAG_FRAC-$AT_R.png"
mv sae_* sae_exp/
