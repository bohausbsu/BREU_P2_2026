"""
Experiment 0 – SPECTRA hyperparameter experiment.
Usage
-----
  python experiment.py --dataset <path>.csv --target-col Placement
"""
...
from snapshot_trainer import load_full_dataset
...
def run_experiment(
    ...
    # ── Outputs ──────────────────────────────────────────────────────────────
    if out_csv:
        fields = ["tp", "fp", "tn", "fn", "precision", "recall", "f1"]
    ...
    if out_png:
        ...
        ax.set_ylabel("Score")
        ax.set_title("Experiment 0: SPECTRA Detection Accuracy")
        ax.set_ylim(0, 1.05)
